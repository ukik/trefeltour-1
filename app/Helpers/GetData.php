            ...
            if (
                ...
                if (isset($row->{$field->field}) && $field->relation['relation_type'] == 'belongs_to_many') {
                    ...
                    if(Auth::check()) {
                        ...
                        $data_table_destination = DB::table($destination_table);
                        ...
                        if($role == 'administrator') {
                            $data_table_destination = $data_table_destination->get();
                        } else {
                            if($destination_table == "badaso_users") {
                                $data_table_destination = $data_table_destination->where('id', Auth::user()->id)->get();
                            } else {
                                $data_table_destination = $data_table_destination->get();
                            }
                        }

                        // $result = collect($data_table_destination);
                    ...
                    $relation_datas = DB::table($destination_table)->select($arr_query_select)->get();
                    ...
                    if(Auth::check()) {
                        ...
                        if($role == 'administrator') {
                            $relation_datas = $relation_datas->get();
                        } else {
                            if($destination_table == "badaso_users") {
                                $relation_datas = $relation_datas->where('id', Auth::user()->id)->get();
                            } else {
                                $relation_datas = $relation_datas->get();
                            }
                        }
                        // $result = collect($relation_datas);
