...
class TourismVenuesRatings extends Model
{
    use HasFactory;
    use SoftDeletes;

    protected $table = "tourism_venues_ratings";
    ...
    {
        return $this->belongsToMany(BadasoUsersPublic::class, 'tourism_venues_ratings', 'id', 'user_id');
    }
