...
class SouvenirStoresRatings extends Model
{
    use HasFactory;
    use SoftDeletes;

    protected $table = "souvenir_stores_ratings";
    ...
    {
        return $this->belongsToMany(BadasoUsersPublic::class, 'souvenir_stores_ratings', 'id', 'user_id');
    }
