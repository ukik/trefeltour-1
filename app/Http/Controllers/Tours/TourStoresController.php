...
class TourStoresController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            \TourStores::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \TourStores::where('id', $request->data['id'])->first();
        ...
        try {
            ...
            $validator = Validator::make($data,
                [
                    ...
                    // 'codepos' => 'max:6',
                    // susah karena pake softDelete, pakai cara manual saja
                    // 'user_id' => 'unique:tour_stores_unique'
                ],
            );
            if ($validator->fails()) {
                $errors = json_decode($validator->errors(), True);
            ...
            $stored_data = \TourStores::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        $check = TourStores::where('id', $value)->with([
            'tourBooking',
            'tourProduct',
            'tourPrice'
        ])->first();
