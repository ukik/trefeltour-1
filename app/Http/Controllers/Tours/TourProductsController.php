...
class TourProductsController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            \TourProducts::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \TourProducts::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \TourProducts::insert($data);
