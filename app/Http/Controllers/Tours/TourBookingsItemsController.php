...
class TourBookingsItemsController extends Controller
{
    ...
    public function browse(Request $request)
    {
        try {
            ...
            $data = \TourBookingsItems::with([
                ...
                'tourBooking.tourPayment',
                'tourBooking.tourPayment.tourPaymentsValidation',
                'tourBooking.tourPayments',
            ])->orderBy('id','desc');
            ...
            if(request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('tour_booking_items');
    ...
    //         $table_entity = \TourBookingsItems::where('id', $request->data['id'])->first();
    ...
    //             'code_table' => ('tour-bookings-items') ,
    ...
    //         \TourBookingsItems::where('id', $request->data['id'])->update($data);
    //         $updated['old_data'] = $table_entity;
    //         $updated['updated_data'] = \TourBookingsItems::where('id', $request->data['id'])->first();
    ...
    //         $stored_data = \TourBookingsItems::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        $check = TourBookingsItems::where('id', $value)->with(['tourPayment'])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = TourBookingsItems::whereIn('id', explode(",",request()['data'][0]['value']))->with('tourPayment')->get();
            $temp = [];
