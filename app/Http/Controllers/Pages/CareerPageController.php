...
class CareerPageController extends Controller
{
    ...
    {
        try {
            $data = \CareerPageModel::with([])->orderBy('id', 'desc');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \CareerPageModel::with([])->whereId($request->id)->first();
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = CareerPageModel::where('id', $request->data['id'])->first();
            ...
            \CareerPageModel::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \CareerPageModel::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \CareerPageModel::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        // $check = CareerPageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = CareerPageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
