...
class ContactSetupPageController extends Controller
{
    ...
    {
        try {
            $data = \ContactSetupPageModel::with([])->orderBy('id', 'desc');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \ContactSetupPageModel::with([])->whereId($request->id)->first();
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = ContactSetupPageModel::where('id', $request->data['id'])->first();
            ...
            $data = [
                ...
                'grid_1_value' => $req['grid_1_value'],
                'grid_2_icon' => $req['grid_2_icon'],
                'grid_2_title' => $req['grid_2_title'],
                'grid_2_value' => $req['grid_2_value'],
                'grid_3_icon' => $req['grid_3_icon'],
                'grid_3_title' => $req['grid_3_title'],
                'grid_3_value' => $req['grid_3_value'],
                'map' => $req['map'],
                'twitter' => $req['twitter'],
            ...
            \ContactSetupPageModel::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \ContactSetupPageModel::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \ContactSetupPageModel::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        // $check = ContactSetupPageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = ContactSetupPageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
