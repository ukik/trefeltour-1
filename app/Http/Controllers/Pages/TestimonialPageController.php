...
class TestimonialPageController extends Controller
{
    ...
    {
        try {
            $data = \TestimonialPageModel::with([])->orderBy('id', 'desc');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \TestimonialPageModel::with([])->whereId($request->id)->first();
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = TestimonialPageModel::where('id', $request->data['id'])->first();
            ...
            \TestimonialPageModel::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \TestimonialPageModel::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \TestimonialPageModel::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        // $check = TestimonialPageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = TestimonialPageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
