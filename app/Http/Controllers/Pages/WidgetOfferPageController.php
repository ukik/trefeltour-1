...
class WidgetOfferPageController extends Controller
{
    ...
    {
        try {
            $data = \WidgetOfferPageModel::with([])->orderBy('id', 'desc');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \WidgetOfferPageModel::with([])->whereId($request->id)->first();
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = WidgetOfferPageModel::where('id', $request->data['id'])->first();
            ...
            $data = [
                ...
                'image1' => imageFilterValue($req['image1']),
                'image2' => imageFilterValue($req['image2']),
                'image3' => imageFilterValue($req['image3']),
                'image4' => imageFilterValue($req['image4']),
                'image5' => imageFilterValue($req['image5']),
                'image6' => imageFilterValue($req['image6']),
                'lang' => $req['lang'],
            ];
            ...
            \WidgetOfferPageModel::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \WidgetOfferPageModel::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \WidgetOfferPageModel::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        // $check = WidgetOfferPageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = WidgetOfferPageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
