...
class HotelLevelPricePageController extends Controller
{
    ...
    {
        try {
            $data = \HotelLevelPricePageModel::with([
            ])->orderBy('id', 'desc');
            ...
            if (request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('page_hotel_level_price');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \HotelLevelPricePageModel::with([])->whereId($request->id)->first();
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = HotelLevelPricePageModel::where('id', $request->data['id'])->first();
            ...
            \HotelLevelPricePageModel::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \HotelLevelPricePageModel::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \HotelLevelPricePageModel::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        // $check = HotelLevelPricePageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = HotelLevelPricePageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
