...
class DestinationPageController extends Controller
{
    ...
    {
        try {
            $data = \DestinationPageModel::with([])->orderBy('id', 'desc');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $request->validate([
                'id' => 'exists:page_destination_data' // . $data_type->name,
            ]);

            // $data = $this->getDataDetail($slug, $request->id);
            $data = \DestinationPageModel::with([])->whereId($request->id)->first();
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = DestinationPageModel::where('id', $request->data['id'])->first();
            ...
            \DestinationPageModel::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \DestinationPageModel::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \DestinationPageModel::insert($data);
    ...
    */
    public function delete(Request $request)
    {
        ...
        // $check = DestinationPageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = DestinationPageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
