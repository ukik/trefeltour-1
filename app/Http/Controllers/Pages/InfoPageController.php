...
class InfoPageController extends Controller
{
    ...
    {
        try {
            $data = \InfoPageModel::with([])->orderBy('id', 'desc');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \InfoPageModel::with([])->whereId($request->id)->first();
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = InfoPageModel::where('id', $request->data['id'])->first();
            ...
            // WAJIB ada str_replace soalnya url domain storage hilang, gak tau kenapa, jadi ini solusinya
            $data['description'] = str_replace("photos/shares", StorageURL()."/storage/photos/shares", $req['description']);
            ...
            \InfoPageModel::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \InfoPageModel::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \InfoPageModel::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        // $check = InfoPageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = InfoPageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
