...
class AboutPageController extends Controller
{
    ...
    {
        try {
            $data = \AboutPageModel::with([])->orderBy('id', 'desc');
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = AboutPageModel::where('id', $request->data['id'])->first();
            ...
            $data = [
                ...
                'grid_1_description' => $req['grid_1_description'],
                'grid_2_icon' => $req['grid_2_icon'],
                'grid_2_title' => $req['grid_2_title'],
                'grid_2_description' => $req['grid_2_description'],
                'grid_3_icon' => $req['grid_3_icon'],
                'grid_3_title' => $req['grid_3_title'],
                'grid_3_description' => $req['grid_3_description'],
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \AboutPageModel::insert($data);
