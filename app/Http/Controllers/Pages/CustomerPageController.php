...
class CustomerPageController extends Controller
{
    ...
    public function browse(Request $request)
    {
        try {
            ...
            if (request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('page_customer');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \CustomerPageModel::with([])->whereId($request->id)->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \CustomerPageModel::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        // $check = CustomerPageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = CustomerPageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
