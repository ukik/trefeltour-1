...
class CareerSetupPageController extends Controller
{
    ...
    {
        try {
            $data = \CareerSetupPageModel::with([])->orderBy('id', 'desc');
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \CareerSetupPageModel::with([])->whereId($request->id)->first();
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = CareerSetupPageModel::where('id', $request->data['id'])->first();
            ...
            \CareerSetupPageModel::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \CareerSetupPageModel::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        //isOnlyAdminSouvenir();
        $setup = CareerSetupPageModel::count();
        if($setup >= 1) return ApiResponse::failed('maksimal 1 data');
        ...
        try {
            ...
            $stored_data = \CareerSetupPageModel::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        // $check = CareerSetupPageModel::where('id', $value)->with([
        //     'souvenirBooking',
        //     'souvenirProduct',
        //     'souvenirPrice'
        // ])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = CareerSetupPageModel::whereIn('id', explode(",", request()['data'][0]['value']))
                // ->with([
                //     'souvenirBooking',
                //     'souvenirProduct',
                //     'souvenirPrice'
