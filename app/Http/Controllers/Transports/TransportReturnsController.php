...
use TransportReturns;
use TravelPayments;

class TransportReturnsController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = \TransportReturns::where('id', $request->data['id'])->first();
            ...
            $validator = Validator::make($data,
                ...
                [
                    'booking_id.unique' => 'Duplikat data booking'
                ]
            );
            if ($validator->fails()) {
            ...
            \TransportReturns::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \TransportReturns::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \TransportReturns::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        $check = TransportBookings::where('booking_id', $value)->first();
        if($check) {
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = TransportReturns::whereIn('id', explode(",",request()['data'][0]['value']))->with('transportBooking')->get();
            $temp = [];
