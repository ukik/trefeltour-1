...
class BadasoUsersController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = \BadasoUsers::where('id', $request->data['id'])->first();
            ...
            \BadasoUsers::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \BadasoUsers::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \BadasoUsers::insert($data);
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = BadasoUsers::whereIn('id', explode(",",request()['data'][0]['value']))->with('transportVehicle')->get();
            $temp = [];
