...
class SouvenirProductsController extends Controller
{
    ...
    public function browse(Request $request)
    {
        try {
            ...
            if(request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('souvenir_products');
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = \SouvenirProducts::where('id', $request->data['id'])->first();

            $store_id = \SouvenirStores::where('id', $table_entity->store_id)->value('id');
            ...
            $updated['updated_data'] = \SouvenirProducts::where('id', $request->data['id'])->first();
