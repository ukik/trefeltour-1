...
class SouvenirCartsController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            // ambil ulang data dari SouvenirCarts
            $from_server_cart = \SouvenirCarts::with([
                'souvenirPrice',
            ])->whereIn('id', $ids)->get();
                ...
                foreach ($from_client as $client) {
                    if($server['customer_id'] == $client['customerId']) {
                        ...
                        array_push($forms, [
                            ...
                            'id' => $server['id'],
                            'total' => getTotalAmount($server->souvenirPrice) * $server->quantity,
                        ]);
            ...
            */
            ...
            $booking_items = SouvenirBookingsItems::insert($cartItems);
