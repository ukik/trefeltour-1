...
class SouvenirPricesController extends Controller
{
    ...
    public function lagia_browse(Request $request)
    {
        try {
            ...
            if(request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('souvenir_prices');
            ...
            if(request()->product) {
                ...
                $additional = SouvenirProducts::whereId(request()->product)->with(['ratingAvg','souvenirStore.ratingAvg'])->first();
            }
            // ================================================
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = \SouvenirPrices::where('id', $request->data['id'])->first();
            ...
            \SouvenirPrices::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \SouvenirPrices::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \SouvenirPrices::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        $check = SouvenirPrices::where('id', $value)->with(['souvenirCart'])->first();
        if($check->souvenirCart) return ApiResponse::failed("Tidak bisa dihapus, data ini digunakan");
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = SouvenirPrices::whereIn('id', explode(",",request()['data'][0]['value']))->with('souvenirCart')->get();
            $temp = [];
            foreach ($filters as $value) {
                if($value->souvenirCart == null) {
