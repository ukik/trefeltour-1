...
class SouvenirPaymentsController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            // NOTIFICATION
            $payload = SouvenirPayments::where('booking_id', $request->data['booking_id'])->first();
            if($payload['is_valid'] === 'true') {
                NotifyToAdmin(new NotifyClientToAdminNotification(Auth::user(), 'souvenir', 'souvenir-payments', $payload, 'Booking Diproses'));
            }
