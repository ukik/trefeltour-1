...
class SouvenirBookingsController extends Controller
{
    ...
    public function browse(Request $request)
    {
        try {
            ...
            if(request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('souvenir_bookings');
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            \SouvenirBookings::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \SouvenirBookings::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = \SouvenirBookings::insert($data);
