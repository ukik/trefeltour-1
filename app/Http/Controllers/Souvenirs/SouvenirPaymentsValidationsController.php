...
class SouvenirPaymentsValidationsController extends Controller
{
    ...
    public function browse(Request $request)
    {
        try {
            ...
            if(request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('souvenir_payments_validations');
                ...
                $data
                    ...
                    ->orWhereHas('souvenirPayment', $payment_id);
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \SouvenirPaymentsValidations::query();
