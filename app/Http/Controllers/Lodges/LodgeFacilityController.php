    ...
    public function browse(Request $request)
    {
        try {
            ...
            if(request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('lodge_facility');
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $data = [
                ...
                'facility_public' => $req['facility_public'],
                'facility_service' => $req['facility_service'],
                'facility_food_drink' => $req['facility_food_drink'],
                'facility_business' => $req['facility_business'],
                'facility_general' => $req['facility_general'],
                'facility_accessibility' => $req['facility_accessibility'],
                'facility_in_room' => $req['facility_in_room'],
                'facility_transportation' => $req['facility_transportation'],
                'facility_nerby' => $req['facility_nerby'],
                'facility_connectivity' => $req['facility_connectivity'],
                'facility_family_friendly' => $req['facility_family_friendly'],
                'facility_things_to_do' => $req['facility_things_to_do'],
                'facility_shuttle_service' => $req['facility_shuttle_service'],
