...
class LodgePricesController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = \LodgePrices::where('id', $request->data['id'])->first();
            ...
            \LodgePrices::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \LodgePrices::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $req = request()['data'];
            $profile_id = LodgeRooms::where('id', $req['room_id'])->value('profile_id');
            ...
            $stored_data = \LodgePrices::insert($data);
