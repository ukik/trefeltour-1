...
use TravelPricesPublic;
use TravelReservations;
use TravelStores;

class TravelPricesPublicController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = TravelPricesPublic::where('id', $request->data['id'])->with('travelReservation')->first();
            ...
            TravelPricesPublic::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = TravelPricesPublic::where('id', $request->data['id'])->first();
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $stored_data = TravelPricesPublic::insert($data);
    ...
    public function delete(Request $request)
    {
        ...
        $check = TravelPricesPublic::where('id', $value)->with(['travelCart'])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = TravelPricesPublic::whereIn('id', explode(",",request()['data'][0]['value']))->with('travelCart')->get();
            $temp = [];
