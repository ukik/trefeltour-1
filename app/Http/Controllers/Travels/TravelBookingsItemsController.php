...
class TravelBookingsItemsController extends Controller
{
    ...
    public function read(Request $request)
    {
        ...
        try {
            ...
            $data = \TravelBookingsItems::query();
    ...
    public function delete(Request $request)
    {
        ...
        $check = TravelBookingsItems::where('id', $value)->with(['travelPayment'])->first();
    ...
    public function deleteMultiple(Request $request)
    {
        ...
        try {
            ...
            // -------------------------------------------- //
            $filters = TravelBookingsItems::whereIn('id', explode(",",request()['data'][0]['value']))->with('travelPayment')->get();
            $temp = [];
