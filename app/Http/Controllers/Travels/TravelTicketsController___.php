...
class TravelTicketsController___ extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $data = [
                ...
                'travel_date' => date("Y-m-d h:m:i", strtotime($req['travel_date'])) ,
                'description' => $req['description'] ,
                'ticket_price' => $req['ticket_price'] ,
                'departure_terminal' => $req['departure_terminal'] ,
                'arrivel_terminal' => $req['arrivel_terminal'] ,
                'code_ticket' => $req['code_ticket'] ,
                'policy' => $req['policy'] ,
                'ticket_discount_price' => $req['ticket_discount_price'] ,
                'code_table' => ($slug) ,
            ...
            \TravelTickets::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \TravelTickets::where('id', $request->data['id'])->first();
