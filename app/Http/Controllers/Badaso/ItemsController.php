...
namespace App\Http\Controllers\Badaso;
...
class ItemsController extends LfmController
{
    ...
    public function getItems()
    {
        ...
        $items = array_merge($this->lfm->folders(), $this->lfm->files()); // original SORT

        // ADDITIONAL sort by Date
    ...
    public function getItems_ORIGINAL()
    {
        $currentPage = self::getCurrentPageFromRequest();
