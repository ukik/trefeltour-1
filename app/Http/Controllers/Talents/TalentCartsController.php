...
class TalentCartsController extends Controller
{
    ...
    public function browse(Request $request)
    {
        try {
            ...
            if(request()->search) {
                ...
                $columns = \Illuminate\Support\Facades\Schema::getColumnListing('talent_carts');
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            // ambil ulang data dari TalentCarts
            $from_server_cart = \TalentCarts::with([
                'talentPrice',
            ])->whereIn('id', $ids)->get();
            ...
            */
            ...
            TalentBookings::insert($forms);

            $bookings = TalentBookings::whereIn('uuid', $uuids)->get();
            ...
            $booking_items = TalentBookingsItems::insert($cartItems);
            ...
            foreach ($bookings as $booking) {
                NotifyToAdmin(new NotifyClientToAdminNotification(Auth::user(), 'talent', 'talent-bookings', $booking, 'Booking Baru'));
            }
