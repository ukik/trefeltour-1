...
/**
  * @OA\Get(
  *      path="/v1/entities/tour-prices",
  *      operationId="browseTourHarga",
  *      tags={"tour-prices"},
  *      summary="Browse Tour Harga",
  *      description="Returns list of Tour Harga",
...
/**
  * @OA\Get(
  *      path="/v1/entities/tour-prices/read?slug=tour-prices&id={id}",
  *      operationId="readTourHarga",
  *      tags={"tour-prices"},
  *      summary="Get Tour Harga based on id",
  *      description="Returns Tour Harga based on id",
  *      @OA\Parameter(
  *          name="id",
  *          required=true,
  *          in="path",
...
/**
  * @OA\Post(
  *      path="/v1/entities/tour-prices/add",
  *      operationId="addTourHarga",
  *      tags={"tour-prices"},
  *      summary="Insert new Tour Harga",
  *      description="Insert new Tour Harga into database",
  *      @OA\RequestBody(
  *         @OA\MediaType(
...
/**
  * @OA\Put(
  *      path="/v1/entities/tour-prices/edit",
  *      operationId="editTourHarga",
  *      tags={"tour-prices"},
  *      summary="Edit an existing Tour Harga",
  *      description="Edit an existing Tour Harga",
  *      @OA\RequestBody(
  *         @OA\MediaType(
  *             mediaType="application/json",
  *             @OA\Schema(
...
/**
  * @OA\Delete(
  *      path="/v1/entities/tour-prices/delete",
  *      operationId="deleteTourHarga",
  *      tags={"tour-prices"},
  *      summary="Delete one record of Tour Harga",
  *      description="Delete one record of Tour Harga",
  *      @OA\RequestBody(
  *         @OA\MediaType(
  *             mediaType="application/json",
  *             @OA\Schema(
...
/**
  * @OA\Delete(
  *      path="/v1/entities/tour-prices/delete-multiple",
  *      operationId="deleteMultipleTourHarga",
  *      tags={"tour-prices"},
  *      summary="Delete multiple record of Tour Harga",
  *      description="Delete multiple record of Tour Harga",
  *      @OA\RequestBody(
  *         @OA\MediaType(
  *             mediaType="application/json",
  *             @OA\Schema(
...
/**
  * @OA\Put(
  *      path="/v1/entities/tour-prices/sort",
  *      operationId="sortTourHarga",
  *      tags={"tour-prices"},
  *      summary="Sort existing Tour Harga",
  *      description="Sort existing Tour Harga",
  *      @OA\RequestBody(
  *         @OA\MediaType(
  *             mediaType="application/json",
  *             @OA\Schema(
