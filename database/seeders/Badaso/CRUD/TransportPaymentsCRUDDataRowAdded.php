...
class TransportPaymentsCRUDDataRowAdded extends Seeder
{
    /**
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                'display_name' => 'Booking (UUID)',
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"transport_bookings","destination_table_column":"id","destination_table_display_column":"uuid","destination_table_display_more_column":["id","uuid"]}',
                    'order' => 3,
                ),
                3 => 
                array (
                ...
                array (
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"transport_drivers","destination_table_column":"id","destination_table_display_column":"name","destination_table_display_more_column":["id","name"]}',
                    'order' => 5,
                ),
                5 => 
                array (
                    ...
                    'field' => 'total_amount',
                    'type' => 'number',
                'display_name' => 'Total Price (Rp) - Sewa Kendaraan',
                    'required' => 0,
                    'browse' => 1,
                    'read' => 1,
                    'edit' => 1,
