...
class TourismBookingItemsCRUDDataRowAdded extends Seeder
{
    /**
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                'display_name' => 'Booking (UUID)',
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"tourism_bookings","destination_table_column":"id","destination_table_display_column":"uuid","destination_table_display_more_column":["uuid","id"]}',
                    'order' => 3,
                ),
                3 => 
                array (
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"tourism_venues","destination_table_column":"id","destination_table_display_column":"name","destination_table_display_more_column":["id","name"]}',
                    'order' => 4,
                ),
                4 => 
                array (
                ...
                array (
                    ...
                    'type' => 'number',
                'display_name' => 'Total Price (Rp) - Tiket',
                    'required' => 0,
                    'browse' => 1,
                    'read' => 1,
                    'edit' => 0,
