...
class LodgeBookingsCRUDDataTypeAdded extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        try {
            ...
            if ($data_type) {
                Badaso::model('DataType')->where('name', 'lodge_bookings')->delete();
            }
            ...
            \DB::table('badaso_data_types')->insert(array (
                ...
                'model_name' => NULL,
                'policy_name' => NULL,
                'controller' => 'App\\Http\\Controllers\\Lodges\\LodgeBookingsController',
                'order_column' => NULL,
                ...
                'updated_at' => '2024-04-25T08:35:43.000000Z',
            ));
            ...
            $menu_item = Badaso::model('MenuItem')
                ...
                ->where('url', '/general/lodge-bookings')
                ->first();
            ...
            if (!is_null($menu_item)) {
                $menu_item->fill([
                    ...
                    'color' => null,
                    'parent_id' => null,
                    'permissions' => 'browse_lodge_bookings',
                    'order' => $order,
                ])->save();
            } else {
                ...
                $menu_item->permissions = 'browse_lodge_bookings';
