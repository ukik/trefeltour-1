...
class TravelReservationsCRUDDataRowAdded extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                array (
                    'data_type_id' => $data_type->id,
                    'field' => 'name_passanger',
                    'type' => 'text',
                    'display_name' => 'Name Penumpang',
                    'required' => 0,
                    'browse' => 1,
                    'read' => 1,
                    'edit' => 1,
