...
class SouvenirCartsCRUDDataRowAdded extends Seeder
{
    /**
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                array (
                    ...
                    'delete' => 0,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"souvenir_prices","destination_table_column":"id","destination_table_display_column":"name","destination_table_display_more_column":["id","name","uuid"]}',
                    'order' => 5,
                ),
                5 => 
                array (
                ...
                array (
                    ...
                    'type' => 'number',
                'display_name' => 'Total Price (Rp) - Barang',
                    'required' => 0,
                    'browse' => 1,
                    'read' => 1,
                    'edit' => 0,
