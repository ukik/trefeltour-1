...
class TransportBookingItemsCRUDDataRowAdded extends Seeder
{
    /**
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                'display_name' => 'Booking (UUID)',
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"transport_bookings","destination_table_column":"id","destination_table_display_column":"uuid","destination_table_display_more_column":["uuid","id"]}',
                    'order' => 3,
                ),
                3 => 
                array (
                ...
                array (
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"transport_vehicles","destination_table_column":"id","destination_table_display_column":"model","destination_table_display_more_column":["id","model"]}',
                    'order' => 6,
                ),
                6 => 
                array (
