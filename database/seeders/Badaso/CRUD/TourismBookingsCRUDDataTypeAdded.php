...
class TourismBookingsCRUDDataTypeAdded extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        try {
            ...
            \DB::table('badaso_data_types')->insert(array (
                ...
                'model_name' => NULL,
                'policy_name' => NULL,
                'controller' => 'App\\Http\\Controllers\\Tourisms\\TourismBookingsController',
                'order_column' => NULL,
                ...
                'updated_at' => '2024-04-25T08:17:27.000000Z',
            ));
            ...
            $menu_item = Badaso::model('MenuItem')
                ...
                ->where('url', '/general/tourism-bookings')
                ->first();
            ...
            if (!is_null($menu_item)) {
                $menu_item->fill([
                    ...
                    'color' => null,
                    'parent_id' => null,
                    'permissions' => 'browse_tourism_bookings',
                    'order' => $order,
                ])->save();
            } else {
                ...
                $menu_item->permissions = 'browse_tourism_bookings';
