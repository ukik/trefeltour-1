...
class TourismPaymentsCRUDDataRowAdded extends Seeder
{
    /**
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                'display_name' => 'Booking (UUID)',
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"tourism_bookings","destination_table_column":"id","destination_table_display_column":"uuid","destination_table_display_more_column":["id","customer_id","venue_id","uuid"]}',
                    'order' => 3,
                ),
                3 => 
                array (
