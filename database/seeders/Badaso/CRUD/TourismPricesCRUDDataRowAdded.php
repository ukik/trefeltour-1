...
class TourismPricesCRUDDataRowAdded extends Seeder
{
    /**
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                array (
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"tourism_venues","destination_table_column":"id","destination_table_display_column":"name","destination_table_display_more_column":["id","uuid","user_id","name"]}',
                    'order' => 3,
                ),
                3 => 
                array (
