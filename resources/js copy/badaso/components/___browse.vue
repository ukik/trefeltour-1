...
<div class="row">
                    ...
                    <shared-select-transport-reserved ref="SharedSelectTransportReserved" @onBubbleEvent="onSelect('is_reserved',$event)" class="col-auto" />
                          ...
                          <span v-else-if="dataRow.type == 'relation'">{{
                            displayRelationData(record, dataRow)
                              ...
                              <div v-else>
                                    ...
                                    <chip-available v-if="dataRow.field == 'is_reserved'" :is_available="record.isReserved"></chip-available>
                                    <span v-else>
                                    {{
                                        record[
                                        $caseConvert.stringSnakeToCamel(dataRow.field)
...
export default {
  ...
  methods: {
    ...
    onClear() {
        ...
        this.$refs?.SharedSelectTransportReserved?.onClear()
    },
    onSelect(field,val) {
        this[field] = val
        this.selected = []
