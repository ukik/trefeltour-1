      ...
      <vs-row v-if="$helper.isAllowedToModifyGeneratedCRUD('add', dataType)">
        <vs-col vs-lg="12">
          <vs-card>
            ...
            <vs-row>
                <vs-col class="mb-4">
                    <vs-alert title="Penting" active="true" color="primary">
                        Sesuaikan data reservasi dengan data ticket jika diperlukan
                    </vs-alert>
                </vs-col>
...
export default {
  ...
  methods: {
    updateTypeHeadReservation(value) {
        console.log('updateTypeHeadReservation', value, this.dataType.dataRows)
