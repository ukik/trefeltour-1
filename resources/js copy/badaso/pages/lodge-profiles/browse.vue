...
<div class="row">
                    ...
                    <shared-select-lodge-profile-rating ref="SharedSelectLodgeProfileRating" @onBubbleEvent="onSelect('rating',$event)" class="col-auto" />
                    <shared-select-lodge-profile-type ref="SharedSelectLodgeProfileType" @onBubbleEvent="onSelect('types',$event)" class="col-auto" />
                    <shared-select-lodge-profile-service ref="SharedSelectLodgeProfileService" @onBubbleEvent="onSelect('services',$event)" class="col-auto" />
