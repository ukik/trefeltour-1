  ...
  <div class="mb-2 mt-3 p-0 col ml-3 pr-2 row">
    ...
    <div
      ...
      @click="
        ...
        show = true;
      "
      class="btn btn-danger col-auto mr-0"
    >
    ...
    <div
      v-if="$route?.name == 'CrudGeneratedAdd' && userRole !== 'admin-tour'"
      @click="onHapus"
      class="btn btn-primary col-auto mr-4"
    >
      Hapus
    </div>
...
export default {
  ...
  methods: {
    onGet(val) {
      axios
        .get(`/api/typehead/tour/dialog_product_tour_stores?id=` + val, {
          headers: {
    ...
    lookupUser: debounce(function () {
      ...
      axios
        .get("/api/typehead/tour/dialog_product_tour_stores?keyword=" + this.query, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
        })
