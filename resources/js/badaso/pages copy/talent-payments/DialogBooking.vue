...
<template>
    <div class="mb-2 mt-3 p-0 col ml-3 pr-2 row">
        ...
        <stack-modal
            ...
            <shared-table-modal-payment-booking v-if="type=='select'" @onBubbleEvent="onBubbleEvent" slug="talent-bookings" />
...
export default {
    ...
    methods: {
        onGet(val) {
            axios
                .get(`/api/typehead/talent/dialog_booking_talent_bookings?id=` + val, {
                    headers: {
