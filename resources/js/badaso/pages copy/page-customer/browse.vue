        ...
        <vs-col vs-lg="12">
          <vs-card>
            <div slot="header">
              ...
              <div class="row">
                <shared-select-available
                  ref="SharedSelectAvailable"
                  @onBubbleEvent="onSelect('available', $event)"
                  class="col-auto"
                />
                <shared-select-lodge-profile-rating
                  ref="SharedSelectLodgeProfileRating"
                  @onBubbleEvent="onSelect('rating', $event)"
                  class="col-auto"
                />
                <shared-select-lodge-profile-type
                  ref="SharedSelectLodgeProfileType"
                  @onBubbleEvent="onSelect('types', $event)"
                  class="col-auto"
                />
                <shared-select-lodge-profile-service
                  ref="SharedSelectLodgeProfileService"
                  @onBubbleEvent="onSelect('services', $event)"
                  class="col-auto"
                />
                      ...
                      >
                        <template v-if="dataRow.browse == 1">
                          ...
                          <div v-else-if="dataRow.type == 'relation'">
                            ...
                            <span v-else>{{ displayRelationData(record, dataRow) }}</span>
                          </div>
...
export default {
  ...
  methods: {
    ...
    onClear() {
      ...
      this.$refs?.SharedSelectLodgeProfileRating?.onClear();
      this.$refs?.SharedSelectLodgeProfileType?.onClear();
      this.$refs?.SharedSelectLodgeProfileService?.onClear();
    },
    onSelect(field, val) {
      this[field] = val;
      this.selected = [];
