        ...
        <template v-if="!isMaintenance">
            <badaso-breadcrumb-row full>
                <template slot="action">
                    <vs-button color="warning" type="relief" v-if="$helper.isAllowedToModifyGeneratedCRUD('edit', dataType)"
                        :to="{
                                    ...
                                    <table class="badaso-table">
                                        <tr>
                                            ...
                                            <td class="badaso-table__value">
                                                <img v-if="dataRow.type == 'upload_image'" :src="record[
                                                    $caseConvert.stringSnakeToCamel(dataRow.field)
                                                    ]
                                                    " width="100%" alt="" />
                                                <div v-else-if="dataRow.type == 'upload_image_multiple'"
                                                    class="crud-generated__item--upload-image-multiple">
                                                    <img v-for="(image, indexImage) in stringToArray(
                                                        record[
                                                        $caseConvert.stringSnakeToCamel(dataRow.field)
                                                        ]
                                                    )" :key="indexImage" :src="image" width="100%" alt=""
                                                        class="crud-generated__item--image" />
                                                </div>
                                                <span v-else-if="dataRow.type == 'editor'" v-html="record[
                                                    $caseConvert.stringSnakeToCamel(dataRow.field)
                                                    ]
                                                    "></span>
                                                <a v-else-if="dataRow.type == 'url'" :href="record[
                                                    $caseConvert.stringSnakeToCamel(dataRow.field)
                                                    ]
                                                    " target="_blank">{{
        record[
            $caseConvert.stringSnakeToCamel(dataRow.field)
                                                ...
                                                <a v-else-if="dataRow.type == 'upload_file'" :href="`${record[
                                                    $caseConvert.stringSnakeToCamel(dataRow.field)
                                                    ]
                                                    }`" target="_blank">{{
        getDownloadUrl(
            ...
            $caseConvert.stringSnakeToCamel(dataRow.field)
                                                ...
                                                <div v-else-if="dataRow.type == 'upload_file_multiple'"
                                                    class="crud-generated__item--upload-file-multiple">
                                                    <p v-for="(file, indexFile) in arrayToString(
                                                                dataRow.value
                                                            )" :key="indexFile">
                                                ...
                                                <p v-else-if="dataRow.type == 'radio' || dataRow.type == 'select'
                                                    ">
                                                    <span v-if="dataRow.field == 'price_id'">
                                                ...
                                                <div v-else-if="dataRow.type == 'select_multiple' ||
                                                        dataRow.type == 'checkbox'
                                                        " class="crud-generated__item--select-multiple">
                                                    <p v-for="(selected, indexSelected) in stringToArray(
                                                        record[
                                                        $caseConvert.stringSnakeToCamel(dataRow.field)
                                                        ]
                                                    )" :key="indexSelected">
                                                ...
                                                <div v-else-if="dataRow.type == 'color_picker'">
                                                    <div class="crud-generated__item--color-picker" :style="`background-color: ${record[
                                                        $caseConvert.stringSnakeToCamel(dataRow.field)
                                                        ]
                                                        }`"></div>
                                                    {{
                                                ...
                                                <div v-else>
                                                    ...
                                                    <div v-else-if="dataRow.field == 'rental_id'">
                                                        <span v-html="record?.userLabel"></span>
                                                    </div>
                                                    <div v-else-if="dataRow.field == 'customer_id'">
                                                        <span v-html="record?.customerLabel"></span>
                                                    </div>
                                                    <span v-else>
                                                        {{
                                                            record[
...
export default {
    ...
    async mounted() {
        this.$openLoader();
        this.isAuth = await this.$store.dispatch("custom/getAuth", this.$api); // this.$authUtil.getAuth(this.$api)
