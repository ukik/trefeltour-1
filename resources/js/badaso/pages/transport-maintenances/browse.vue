...
<div class="row">
                    <shared-select-transport-maintenance ref="SharedSelectTransportMaintenance" @onBubbleEvent="onSelect('is_maintenance',$event)" class="col-auto" />
...
export default {
  ...
  methods: {
    ...
    onClear() {
        ...
        this.selectedMulti = []
        this.getEntity();
        this.$refs?.SharedSelectTransportMaintenance?.onClear()
    },
    onSelect(field,val) {
        this[field] = val
        this.selected = []
