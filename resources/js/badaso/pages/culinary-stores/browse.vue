...
<div class="row">
                    ...
                    <shared-select-culinary-store-category ref="SharedSelectCulinaryStoreCategory" @onBubbleEvent="onSelect('category',$event)" class="col-auto" />
...
export default {
  ...
  methods: {
    ...
    onClear() {
        ...
        this.$refs?.SharedSelectCulinaryStoreCategory?.onClear()
    },
    onSelect(field,val) {
        this[field] = val
        this.selected = []
