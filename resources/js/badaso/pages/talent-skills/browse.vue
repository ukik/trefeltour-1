...
<div class="row">
                    <shared-select-talent-skill-category ref="SharedSelectTalentSkillCategory" @onBubbleEvent="onSelect('category',$event)" class="col-auto" />
...
export default {
  ...
  methods: {
    ...
    onClear() {
        ...
        this.selectedMulti = []
        this.getEntity();
        this.$refs?.SharedSelectTalentSkillCategory?.onClear()
    },
    onSelect(field,val) {
        this[field] = val
        this.selected = []
