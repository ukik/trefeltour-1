        ...
        <vs-col vs-lg="12">
          <vs-card>
            <div slot="header">
              ...
              <DialogUser v-if="this.$store.getters['custom/isAdmin']" @onBubbleEvent="updateTypeHead($event)" />
            ...
            <vs-row>
              ...
              >
                ...
                <template v-if="dataRow.add == 1">
                    ...
                    v-if="dataRow.type == 'text' && dataRow.field !== 'name'"
                  ...
                  <badaso-text required
                    v-else-if="dataRow.type == 'text' && dataRow.field == 'name' && !$store.getters['custom/isAdmin']"
                    :label="dataRow.displayName"
                    :placeholder="dataRow.displayName"
                    v-model="dataRow.value"
                    size="12"
                  ...
                  <badaso-text required
                    v-else-if="dataRow.type == 'text' && dataRow.field == 'name' && dataRow.show && $store.getters['custom/isAdmin']"
                    :label="dataRow.displayName"
                    :placeholder="dataRow.displayName"
                    v-model="dataRow.value"
                    size="12"
                  ...
                  <badaso-textarea
                    v-else-if="dataRow.type == 'textarea' && dataRow.field == 'catatan_followup' && dataRow.show"
                    :label="dataRow.displayName"
                    :placeholder="dataRow.displayName"
                    v-model="dataRow.value"
                    size="12"
                  ...
                  <badaso-select
                    v-else-if="dataRow.type == 'select' && dataRow.field == 'is_followup' && dataRow.show"
                    :label="dataRow.displayName"
                    :placeholder="dataRow.displayName"
                    v-model="dataRow.value"
                    size="12"
  ...
  data: () => ({
    ...
    async mounted() { this.$openLoader();
        ...
        temp.forEach(el => {
            ...
            if(el.field == "name") {
                el.show = this.$store.getters['custom/isAdmin'] ? false : true
            }

            if(el.field == "is_followup") {
                el.show = this.$store.getters['custom/isAdmin'] ? true : false
            }

            if(el.field == "catatan_followup") {
                el.show = this.$store.getters['custom/isAdmin'] ? true : false
            }
