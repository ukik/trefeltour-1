...
<div class="row">
                    <shared-select-offer-type ref="SharedSelectOfferType" @onBubbleEvent="onSelect('type',$event)" class="col-auto" />
                    <shared-select-offer-category ref="SharedSelectOfferCategory" @onBubbleEvent="onSelect('category',$event)" class="col-auto" />
                    <shared-select-offer-followup ref="SharedSelectOfferFollowup" @onBubbleEvent="onSelect('followup',$event)" class="col-auto" />
                      ...
                      >
                        <template v-if="dataRow.browse == 1">
                          ...
                          <div v-else>
                                    ...
                                    <div v-else-if="dataRow.field == 'user_followup_id'">
                                        {{ record?.badasoUserFollowup?.username }}
                                    </div>
                                    <span v-else>
                                    {{
                                        record[
...
export default {
  ...
  methods: {
    ...
    onClear() {
        ...
        this.selectedMulti = []
        this.getEntity();
        this.$refs?.SharedSelectOfferType?.onClear()
        this.$refs?.SharedSelectOfferCategory?.onClear()
        this.$refs?.SharedSelectOfferFollowup?.onClear()
    },
    onSelect(field,val) {
        this[field] = val
        this.selected = []
