...
<body>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            Pembayaran berhasil
                        @endif
                <button class="btn btn-primary" id="pay-window">V3</button>
                    </div>
                </div>
    ...
    <script>
        ...
        const payWindow = document.querySelector('#pay-window');
        payWindow.addEventListener('click', function(e) {
            ...
            // } else {
                ...
                window.open('https://app.sandbox.midtrans.com/snap/v2/vtweb/{{ $snapToken }}', '_blank', options);
