                            ...
                            <td class="wrapper"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td>
                                            <p>Hi {{ $user->name }},</p>
                                            <p>Anda menerima email ini karena kami menerima permintaan pengaturan ulang kata sandi untuk akun Anda. Berikut adalah kode verifikasi untuk akun Anda: </p>

                                            <h1>{{$token}}</h1>

                                            <p>Yang perlu Anda lakukan adalah menyalin kode verifikasi dan menempelkannya ke formulir verifikasi email untuk melanjutkan proses pengaturan ulang kata sandi.</p>
