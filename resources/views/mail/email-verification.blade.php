              ...
              <td class="wrapper"
                ...
                <table border="0" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                    <td>
                      <p>Hi {{ $user->name }},</p>
                      <p>Terima kasih telah menggunakan {{ config('app.name') }}. Sebelum memulai, kami hanya perlu mengonfirmasi bahwa ini memang Anda. Berikut kode verifikasi untuk akun Anda: </p>

                      <h1>{{$token}}</h1>

                      <p>Yang perlu Anda lakukan adalah menyalin kode verifikasi dan menempelkannya ke <a href="{{ \URL::to(\config('badaso.admin_panel_route_prefix').'/verify') }}?email={{$user->email}}">this form</a> untuk menyelesaikan proses verifikasi email.</p>
